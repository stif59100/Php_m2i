...
<html>
    ...
    <body>
        ...
        <form method="get" action="../controls/InscriptionCTRLV5.php">
            ...
            function getOptionsFromOrdinalArray(array $to): string {
                $options = "";
            ...
            function getOptionsFromIntervalNumber(int $smallVal, int $bigVal, int $thisVal): string{
                 $options = "";        
             for ($i = $smallVal; $i <= $bigVal; $i++) {
                            $i = ($i < 10) ? 0 . $i : $i;
                            if ($i == $thisVal) {
            ...
            function getOptionsMonth($tMois): string{
                $options = "";
            ...
            function getOptionsYear($annee): string{
                $options = "";
            ...
            function getOptionsFromKeyArray(array $tc): string{
                $options = "";
            ...
            <select name="jour">
                ...
                //echo getOptionsDay($jour);
                 echo getOptionsFromIntervalNumber(1, 31, $jour) ;
                ?>
            </select>
            ...
            <select name="annee">
                ...
                <?php
               echo getOptionsFromIntervalNumber(1920, $annee, $annee) ;
            ...
            <select name="ville">
               ...
               // $optionsVilles = "";
                ...
                //}
                //echo $optionsVilles;
                echo getOptionsFromKeyArray($villes);
                ?>
            </select>
            <br>
